        ...
        for snr in snrs:
            ...
            for thr, nu in regulation_params:
                ...
                try:
                    ...
                    results_list_all.append(ires)
                    print('Error in model.fit. Continue.')
                    continue
...
def sindy_fit(system_name, X, t, x_dot=[], threshold=0.1, nu=1, use_default_library=False):

    # library
    if use_default_library:
        lib = create_library_default()
    else:
...
if __name__ == "__main__":
    ...
    root_dir = "D:\\Experiments\\dynobench"
